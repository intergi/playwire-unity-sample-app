...
- (void)fullScreenAdDidFailToLoad:(PWFullScreenAd * _Nonnull)ad error:(PWAdError * _Nonnull)error {
  ...
  NSString* message = [PWUnityMessageBuilder buildWithName:PW_Rewarded_FailedToLoad_Event adUnitId:self.adUnit parameters:params];
  [PWUnityManager sendUnityMessage:message];
}
...
- (void)fullScreenAdDidFailToPresentFullScreenContent:(PWFullScreenAd * _Nonnull)ad error:(PWAdError * _Nonnull)error {
  ...
  self.isUsed = YES;
  NSString* message = [PWUnityMessageBuilder buildWithName:PW_Rewarded_FailedToOpen_Event adUnitId:self.adUnit parameters:params];
  [PWUnityManager sendUnityMessage:message];
}
