...
Before running the app on a device/emulator, you must update `settings.gradle` in the exported Android Studio project. Replace the placeholders 'USERNAME' and 'PASSWORD' with your actual artifact credentials.
  ```gradle
  credentials {  
      username = 'USERNAME'  
      password = 'PASSWORD'  
